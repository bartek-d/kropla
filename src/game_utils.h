...
class CleanupOneVar
{
   ...
   public:
    CleanupOneVar(T* ref, T new_val) : ref_value(ref), saved_value(*ref)
    {
        *ref = new_val;
    }
...
template <int MaxKeys, int MaxElems>
typename SmallMultimap<MaxKeys, MaxElems>::T&
SmallMultimap<MaxKeys, MaxElems>::group(int g)
{
    assert(g < MaxKeys);
...
template <int MaxKeys, int MaxElems>
typename SmallMultimap<MaxKeys, MaxElems>::T&
SmallMultimap<MaxKeys, MaxElems>::numberOfElems(int g)
{
    assert(g < MaxKeys);
...
template <int MaxKeys, int MaxElems>
typename SmallMultimap<MaxKeys, MaxElems>::T&
SmallMultimap<MaxKeys, MaxElems>::elem(int g, int n)
{
    assert(g < MaxKeys);
    assert(n < MaxElems);
